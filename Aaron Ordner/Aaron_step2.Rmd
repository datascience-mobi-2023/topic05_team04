...
for (gene_name in w.genes.cancer) {
    ...
    new_row <- c(frequency_value, achilles_value, exp_value, p_value, treatments)
...
colnames(Wgene.krebs) <- c("Frequency in list.targets", "mean prism.achilles", "mean prism.exp", "p-value from achilles.genes.adj", "treatments")

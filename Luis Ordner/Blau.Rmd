...
## UMAP
breast_cancer_umap <- umap(t(breast_prism_imp[,pref_drug_con_combo]), n_neighbors = 15, n_components = 2)
...
top_10_levels <- sorted_levels[1:10]

## Plot the UMAP
plot(breast_cancer_umap$layout, main = "UMAP of the Breastcancer celllines")
```
```{r}

...
hist(vec_breast, breaks = 100, xlab = "Cell Growth", main = "Overview of the Cell Growth")#;abline(v = mean(vec_breast, na.rm = TRUE), col = "red", lwd = 2, lty = 3);abline(v = quantile(breast_prism, probs = c(0.25, 0.5, 0.75), na.rm = TRUE), col = "blue", lwd = 2, lty= 3)
```
```

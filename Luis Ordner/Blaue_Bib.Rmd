...
breast_prism_lowest <- breast_prism_imp[,pref_drug_ths_b]
##############
### PRISM ### 
##############
...
prism_lowest <- prism_imp[,pref_drug_ths]
##########################################
...
breast_prism_lowest #<--! most efficient drugs for breast cellines (threshold: -2)-->
prism_lowest #<--! most efficient drugs for all cellines (threshold: -2) -->
################
# NICE TO HAVE #
################

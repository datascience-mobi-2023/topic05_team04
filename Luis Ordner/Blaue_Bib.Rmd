...
top_x_levels <- sorted_levels[1:10]  ### <---! USER INPUT --->
...
umap_layout_breast$levels_b <- meta_eff_treat$levels_b
...
ggplot(umap_layout_breast, aes(x = V1, y = V2, colour = levels_b, alpha_levels_b)) +
...
ggplot() +
    geom_histogram(aes(x = vec_breast, fill = inhibitory), bins = 150) +
    scale_fill_manual(values = c("#f54949", "steelblue")) +
    labs(title = "Histogram of Breast Prism", x = "Cell Growth", y = "Count")

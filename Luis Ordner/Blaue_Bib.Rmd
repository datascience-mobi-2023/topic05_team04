...
breast_prism_lowest <- breast_prism_imp[,pref_drug_con_combo_b]
##############
### PRISM ### 
##############
...
###########################################
###### VARIANCE TREATMENT ALL CANCER ###### Aaron
###########################################
...
prism.var.mean <- sapply(rel.cl$lineages, function(x) {
    mean(prism_var[prism.cl$lineage %in% x])
    })

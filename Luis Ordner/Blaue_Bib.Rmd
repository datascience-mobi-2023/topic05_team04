...
ggplot() +
    ...
    labs(title = "Lowest mean Cell growth and respective concentraions", x = "Concentration", y = "Count")
#hist(as.numeric(highest_mean_duplicate_b$concentration_b))
#### Plot 2
ggplot() +
    geom_histogram(aes(x = highest_mean_duplicate_b$concentration_b), bins = 10, fill = "steelblue") + 
    labs(title = "Highest mean Cell growth and respective concentraions", x = "Concentration", y = "Count")
# --------------------------------- #

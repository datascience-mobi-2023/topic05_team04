...
pref_drug_ths_b <- rownames(lowest_mean_duplicate_b[lowest_mean_duplicate_b$colMeans_breast < -2,])
...
pref_drug_ths <- rownames(lowest_mean_duplicate[lowest_mean_duplicate$colMeans < -2,])
...
color_palette <- c(setNames(level_colors, top_x_levels), Other = "transparent")
################ Sharu
...
# Spearrman corr between the concentration and the colMean
plot(lowest_mean_duplicate_b$concentration_b,lowest_mean_duplicate_b$colMeans_breast)
cor(lowest_mean_duplicate_b$colMeans_breast, as.numeric(lowest_mean_duplicate_b$concentration_b), method = "spearman")
```
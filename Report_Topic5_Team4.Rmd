...
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Histogram of the correlation between gene expression and gene copy number. Mean and median are shown by red and blue dashed lines.', out.width='0.65\\linewidth'}
breast_prism.cl <- prism.cl[which(prism.cl$lineage == 'breast'), ]

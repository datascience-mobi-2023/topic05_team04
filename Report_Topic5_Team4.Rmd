...
The analyis of the different doses revealed a trend, Figure 1 shows that higher doses result in a lower average prism score. Figue ?? also validates this discovery, 85% of the treatments have a high correlation between concentration and average prism score. This can also be seen when looking at the distribution of R^2 values of the linear regression models that were computed for every drug. The majority of drugs have a R^2 value above 0.5 and higher, which indicates a good fit of the regression line. But a disclaimer has to be made, the models were only build with around 8 data points and more testing is needed to fully validate these models.

...
PLOT 1 and PLOT 2
```{r, label= 'Mylabel1', echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\textbf{Titel Abbildung} Bild unterschrift', out.width='0.65\\linewidth'}
# hier dann code für den plot eingeben. Oben schreiben wir, dass man die entsprechenden Variablen aus den anderen rmd files laden muss. können wir auch nochmal ganz oben als disclaimer in den package download chunk packen.
#### Plot 1
ggplot1 <- ggplot() +
...
```{r, label= 'Mylabel2', echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\textbf{Titel Abbildung} Bild unterschrift', out.width='0.65\\linewidth'}
...
```{r, label= 'Mylabel3', echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\textbf{Titel Abbildung} Bild unterschrift', out.width='0.65\\linewidth'}
plot_reg(testname)
```
...
```{r, label= 'Mylabel4', echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\textbf{Titel Abbildung} Bild unterschrift', out.width='0.65\\linewidth'}
...
```{r, label= 'Mylabel5', echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\textbf{Titel Abbildung} Bild unterschrift', out.width='0.65\\linewidth'}
...
# Appendix
```{r, label= 'Mylabel6', echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\textbf{Titel Abbildung} Bild unterschrift', out.width='0.65\\linewidth'}
ggplot() +

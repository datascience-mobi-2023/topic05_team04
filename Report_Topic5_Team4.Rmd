...
Analysing the main datasets led to many individual data formats such as data frames, lists etc. which contain relevant information gathered by our code. The aim of the search engine was to quickly look up a gene of interest and display its attached values out of our main gene-related cell line datasets for a more simple process of gene analysis. Based on this code, applications like looking for suitable treatments in the prism data frame, loops which undergo printing every gene and their attached values in breast cancer celllines and the first approach for a relevant final data frame were realized.
...
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='\\ Histogram of which concentration concentrations results in the lowest (left) or highest (right) average prism score.', out.width='0.65\\linewidth'}
...
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Histogram of the mean log 2 fold change of the drugs after the first round of filtering. The colors indicate if the drugs is below or above the selected threshold of -2.', out.width='0.65\\linewidth'}
#### Plot 3
...
```{r, fig.dim=c(10,6), echo = FALSE, message=FALSE, fig.align='center', fig.cap='UMAP of the inhibitory treatments with the PRISM scores labelled by the MOA', out.width='0.65\\linewidth'}
...
```{r, fig.dim=c(10,6), echo = FALSE, message=FALSE, fig.align='center', fig.cap='UMAP of the inhibitory treatments with the PRISM scores labelled by the MOA with cluster encircelment', out.width='0.65\\linewidth'}
ggplot(umap_layout_prism, aes(x = V1, y = V2, color = levels, alpha = alpha_level)) +
  geom_point(size = 3) +
...
```{r,warning = FALSE, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Histogram of the correlation between gene expression and gene copy number. Mean and median are shown by red and blue dashed lines.', out.width='0.65\\linewidth'}
breast_prism.cl <- prism.cl[which(prism.cl$lineage == 'breast'), ]
...
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Histogram of the correlation between the different concentrations and the respective average prism score. Correlations below the set threshold of -0.7 are colored red and correlations higher that -0.7 are colored blue.', out.width='0.65\\linewidth'}
####################################
...
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Boxplott of the gene knockout scores for the gene SDHC for breast cancer lineages compared to all the other lineages', out.width='0.65\\linewidth'}
...
```
```{r, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Bild unterschrift', out.width='0.65\\linewidth'}
#### Plot 7
ggplot() +

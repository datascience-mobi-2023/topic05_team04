...
barplot(prism_pca_prop.var[1:20],ylab='Proportion of variance') # we only plot the first 20 PCs
ggplot(prism_pca, aes(x = V1, y = V2, color = levels, alpha = alpha_level)) +
    geom_point(size = 3) +
    scale_color_manual(values = color_palette0) +
    theme_bw() +
    ggtitle("UMAP of all celllines")
